...
class GeminiSummaryClientTest {
    ...
    fun `builds documented structured output request and parses valid summary`() {
        ...
        assertThat(transport.requestBody["generationConfig"].toString()).contains("responseFormat")
        assertThat(transport.requestBody["generationConfig"].toString()).contains("mimeType=application/json")
