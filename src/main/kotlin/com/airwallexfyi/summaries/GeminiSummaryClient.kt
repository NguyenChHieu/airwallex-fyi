...
class GeminiSummaryClient(
    ...
    private fun promptFor(article: ExtractedArticle): String = buildString {
        ...
        appendLine("Use 3 to 5 concrete key-point bullets with complete, self-contained sentences.")
        appendLine("Do not truncate thoughts or end bullets mid-idea.")
        appendLine("Avoid hype, alert language, and generic phrases.")
        appendLine("Make why_it_matters a complete business or technical impact summary.")
        appendLine()
